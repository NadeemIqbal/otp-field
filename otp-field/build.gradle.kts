...
android {
    namespace = "io.github.nadeemiqbal.otpfield"
...
mavenPublishing {
    ...
    coordinates("io.github.nadeemiqbal", "otp-field", libVersion)

    pom {
        name.set("OtpField")
        description.set(
            "A polished segmented OTP / PIN input for Compose Multiplatform — auto-advance focus, " +
                "multiplatform clipboard paste, obscure mode, and an error shake animation.",
        )
        inceptionYear.set("2026")
        url.set("https://github.com/NadeemIqbal/otp-field")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/NadeemIqbal/otp-field")
            connection.set("scm:git:git://github.com/NadeemIqbal/otp-field.git")
            developerConnection.set("scm:git:ssh://git@github.com/NadeemIqbal/otp-field.git")
        }
    }
}
